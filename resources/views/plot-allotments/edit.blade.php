...
@push('title', 'Update Plot Allotment')
...
@section('content')
    ...
    <div class="d-flex flex-column-fluid"
         x-data="{
         owner_question_id: '{{ old('owner_question_id', $plotAllotment->owner_question_id) }}',
         business_structure_id: '{{ old('business_structure_id', $plotAllotment->business_structure_id) }}',
         }"
         x-init="() => {
                ...
                <div class="">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <h3 class="card-title">Update Plot Allotment</h3>

                        </div>

                        <!--begin::Form-->
                        {!! Form::open(array('id'=>'form_add_edit','route' => ['plot-allotments.update', $plotAllotment],'method'=>'PUT')) !!}
                        <div class="card-body">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select class="form-control select2" name="special_economic_zone_id" required style="width: 100% !important;">
                                            ...
                                            @foreach($specialEconomicZones as $specialEconomicZone)
                                                <option {{ old('special_economic_zone_id', $plotAllotment->special_economic_zone_id)== $specialEconomicZone->id ? 'selected': '' }} value="{{ $specialEconomicZone->id }}"> {{ $specialEconomicZone->name }} </option>
                                            @endforeach
                                        </select>
                                                    ...
                                                    @isset($questions)
                                                        @foreach($questions as $question)
                                                            <label class="radio radio-primary">
                                                                <input type="radio" name="owner_question_id" x-model="owner_question_id" value="{{ $question->id }}" {{ old('owner_question_id', $plotAllotment->owner_question_id)==$question->id?'checked':'' }} required>
                            ...
                            <div x-show.transition.opacity="owner_question_id=='1'" class="section_box">
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-6">
                                        ...
                                        <input maxlength="50" type="text" name="business_name" class="form-control" placeholder="Business Name" value="{{ old('business_name', $plotAllotment->business_name) }}" required />
                                        @error('business_name')
                                        <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select x-ref="select" class="form-control select2" name="business_structure_id"   style="width: 100% !important;" required>
                                            ...
                                            @foreach($businessStructures as $businessStructure)
                                                <option {{ old('business_structure_id', $plotAllotment->business_structure_id)== $businessStructure->id ? 'selected': '' }} value="{{ $businessStructure->id }}"> {{ $businessStructure->structure_name }} </option>
                                            @endforeach
                                        </select>
                                ...
                                <div x-show.transition.opacity="['3','4','5'].includes(business_structure_id)" class="row form-group">
                                    <div class="col-lg-6">
                                        ...
                                        <input maxlength="20" type="text" name="secp_company_incorporation_no" class="form-control" placeholder="SECP Company Incorporation No" value="{{ old('secp_company_incorporation_no', $plotAllotment->secp_company_incorporation_no) }}" required />
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input maxlength="20" type="text" name="company_incorporation_date" class="form-control datepicker w-100" readonly placeholder="Company Incorporation Date" value="{{ old('company_incorporation_date', $plotAllotment->company_incorporation_date) }}" required />
                                ...
                                <div x-show.transition.opacity="business_structure_id!=''" class="row form-group">
                                    ...
                                    <div x-show.transition.opacity="business_structure_id=='2'" class="col-lg-6">
                                        ...
                                        <input maxlength="20" type="text" name="business_registration_no" class="form-control" placeholder="Registration No." value="{{ old('business_registration_no', $plotAllotment->business_registration_no) }}" required />
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input maxlength="20" type="text" name="business_ntn" class="form-control" placeholder="Business NTN" value="{{ old('business_ntn', $plotAllotment->business_ntn) }}" required />
                                        @error('business_ntn')
                                        <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div  x-show.transition.opacity="['3','4','5'].includes(business_structure_id)"  class="row form-group">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-form-label">
                                            <div class="radio-inline">
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="company_structure" value="Joint Venture with Foreign Company" {{ old('company_structure', $plotAllotment->company_structure)=='Joint Venture with Foreign Company'?'checked':'' }} required>
                                                    <span></span>Joint Venture with Foreign Company</label>
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="company_structure" value="Foreign Company" {{ old('company_structure', $plotAllotment->company_structure)=='Foreign Company'?'checked':'' }} required>
                                                    <span></span>Foreign Company</label>
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="company_structure" value="Local Company" {{ old('company_structure', $plotAllotment->company_structure)=='Local Company'?'checked':'' }} required>
                            ...
                            <div x-show.transition.opacity="owner_question_id=='1'" class="section_box">
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-6">
                                        ...
                                        <input maxlength="254" type="text" name="business_address" class="form-control" placeholder="Address" value="{{ old('business_address', $plotAllotment->business_address) }}" required />
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select class="form-control select2" name="province_id" onchange="getProvinceDistricts(this)" style="width: 100% !important;" required>
                                            ...
                                            @foreach($provinces as $province)
                                                <option {{ old('province_id', $plotAllotment->province_id)== $province->id ? 'selected': '' }} value="{{ $province->id }}"> {{ $province->province_name }} </option>
                                            @endforeach
                                        </select>
                                        @error('province_id')
                                        <div class="error">{{ $message }}</div>
                            ...
                            <div x-show.transition.opacity="owner_question_id=='1'" class="section_box">
                                <div class="row form-group">
                                    <div class="col-lg-6">
                                        ...
                                        <input maxlength="20" type="text" name="business_phone_no" class="form-control" placeholder="Phone No." value="{{ old('business_phone_no', $plotAllotment->business_phone_no) }}" required />
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input maxlength="20" type="text" name="business_fax_no" class="form-control" placeholder="Fax No." value="{{ old('business_fax_no', $plotAllotment->business_fax_no) }}" />
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-6">
                                        ...
                                        <input maxlength="254" type="text" name="website_url" class="form-control" placeholder="Website URL" value="{{ old('website_url', $plotAllotment->website_url) }}" />
                                        @error('website_url')
                                        <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <input maxlength="100" type="email" name="business_email_address" class="form-control" placeholder="Email Address" value="{{ old('business_email_address', $plotAllotment->business_email_address) }}" />
                            ...
                            <div x-show.transition.opacity="owner_question_id=='1' || owner_question_id=='2'" class="section_box">
                                <div class="row form-group">
                                    <div class="col-lg-6">
                                        ...
                                        <input maxlength="50" type="text" name="full_name" class="form-control" placeholder="Full Name" value="{{ old('full_name', $plotAllotment->full_name) }}" required />
                                        @error('full_name')
                                        <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input maxlength="20" type="text" name="cnic_no" class="form-control cnic-no" placeholder="CNIC No." value="{{ old('cnic_no', $plotAllotment->cnic_no) }}" required />
                                        @error('cnic_no')
                                        <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input maxlength="50" type="text" name="mobile_no" class="form-control mobile-no" placeholder="Mobile No." value="{{ old('mobile_no', $plotAllotment->mobile_no) }}" required />
                                        @error('mobile_no')
                                        <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <label>Email Address <span class="color-red-700"></span></label>
                                        <input maxlength="100" type="email" name="email_address" class="form-control" placeholder="Email Address" value="{{ old('email_address', $plotAllotment->email_address) }}"  />
                                        @error('email_address')
                                        <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-6">
                                        <label>Landline Phone No. <span class="color-red-700"></span></label>
                                        <input maxlength="20" type="text" name="phone_no" class="form-control" placeholder="Phone No." value="{{ old('phone_no', $plotAllotment->phone_no) }}" />
                                        @error('phone_no')
                                        <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div x-show.transition.opacity="owner_question_id=='1'" class="col-lg-6">
                                        <label>Fax No. <span class="color-red-700"></span></label>
                                        <input maxlength="20" type="text" name="fax_no" class="form-control" placeholder="Fax No." value="{{ old('fax_no', $plotAllotment->fax_no) }}"  />
                                        @error('fax_no')
                                        <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="rep-addresses m_repeater_section">
                                    ...
                                    <div  data-repeater-list="addresses">
                                        @for($index =0; $index<$addresses_count; $index++)
                                            @component('plot-allotments.address-item', ['index'=> $index, 'provinces'=> $provinces, 'addresses'=>$plotAllotment->addresses, 'districts'=>$districts,'tehsils'=>$tehsils]) @endcomponent
                                        @endfor
                            ...
                            <div class="section_box">
                                <div class="row form-group">
                                    <div class="col-lg-12">
                                        ...
                                        <textarea name="remark" class="form-control" rows="5">{{ old('remark',$plotAllotment->remark) }}</textarea>
                                        @error('remark')
                                        <div class="error">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-form-label">
                                            <div class="radio-inline">
                                                <label class="radio radio-primary">
                                                    <input type="radio" name="status" value="1" {{ old('status', $plotAllotment->status)=='1'?'checked':'' }}>
                                                    <span></span>Active</label>

                                                <label class="radio radio-primary">
                                                    <input type="radio" name="status" value="0" {{ old('status', $plotAllotment->status)=='0'?'checked':'' }}>
...
@push('post-scripts')
    ...
    <script>
        ...
        @if(old('province_id', $plotAllotment->province_id))
        var selected_district = {{ old('district_id', $plotAllotment->district_id) }};
        getDistricts('#district_id',{{ old('province_id', $plotAllotment->province_id) }}, selected_district);
        @endif

        @if(old('district_id', $plotAllotment->district_id))
        var selected_tehsil = {{ old('tehsil_id', $plotAllotment->tehsil_id) }};
        getTehsils('#tehsil_id',{{ old('district_id',$plotAllotment->district_id) }}, selected_tehsil);
        @endif
