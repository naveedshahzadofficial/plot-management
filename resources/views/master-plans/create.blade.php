<div class="card card-custom gutter-b">
                        <div class="card-header" style="background: transparent !important;">
                            <h3 class="card-title">Add Master Plan</h3>

                        </div>

                    <!--begin::Form-->
                    {!! Form::open(array('id'=>'form_add_edit','route' => ['special-economic-zones.master-plans.store', $specialEconomicZone],'method'=>'POST','files' => 'true')) !!}
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    <label>Upload Master Plan File <span class="color-red-700">*</span></label>
