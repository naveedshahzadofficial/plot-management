                ...
                <div class="">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header">
                            <h3 class="card-title">Update Plot</h3>

                        </div>

                        <!--begin::Form-->
                        {!! Form::open(array('id'=>'form_add_edit','route' => ['plots.update', $plot],'method'=>'PUT')) !!}
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-control select2" name="special_economic_zone_id">
                                        ...
                                        @foreach($specialEconomicZones as $specialEconomicZone)
                                            <option {{ old('special_economic_zone_id', $plot->special_economic_zone_id)== $specialEconomicZone->id ? 'selected': '' }} value="{{ $specialEconomicZone->id }}"> {{ $specialEconomicZone->name }} </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input maxlength="10" type="text" name="plot_no" class="form-control" placeholder="Plot No." value="{{ old('plot_no', $plot->plot_no) }}" />
                                    @error('plot_no')
                                    <div class="error">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row form-group">
                                    ...
                                    <div class="col-form-label">
                                        <div class="radio-inline">
                                            <label class="radio radio-primary">
                                                <input type="radio" name="plot_type" value="Industrial" {{ old('plot_type', $plot->plot_type)=='Industrial'?'checked':'' }}>
                                                <span></span>Industrial</label>

                                            <label class="radio radio-primary">
                                                <input type="radio" name="plot_type" value="Commercial" {{ old('plot_type', $plot->plot_type)=='Commercial'?'checked':'' }}>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input maxlength="20" type="text" name="plot_size" class="form-control money_format" placeholder="Plot Size" value="{{ old('plot_size', $plot->plot_size) }}" />
                                    @error('plot_size')
                                    <div class="error">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row form-group">
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-form-label">
                                        <div class="radio-inline">
                                            <label class="radio radio-primary">
                                                <input type="radio" name="plot_status" value="Sold" {{ old('plot_status', $plot->plot_status)=='Sold'?'checked':'' }}>
                                                <span></span>Sold</label>

                                            <label class="radio radio-primary">
                                                <input type="radio" name="plot_status" value="Unsold" {{ old('plot_status', $plot->plot_status)=='Unsold'?'checked':'' }}>
                            ...
                            <div class="row form-group">
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-form-label">
                                        <div class="radio-inline">
                                            <label class="radio radio-primary">
                                                <input type="radio" name="status" value="1" {{ old('status', $plot->status)=='1'?'checked':'' }}>
                                                <span></span>Active</label>

                                            <label class="radio radio-primary">
                                                <input type="radio" name="status" value="0" {{ old('status', $plot->status)=='0'?'checked':'' }}>
