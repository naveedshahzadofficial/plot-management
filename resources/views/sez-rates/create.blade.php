<div class="card card-custom gutter-b example example-compact">
                        <div class="card-header" style="background: transparent !important;">
                            <h3 class="card-title">Add SEZ Rate</h3>

                        </div>

                    <!--begin::Form-->
                    {!! Form::open(array('id'=>'form_add_edit','route' => ['special-economic-zones.sez-rates.store', $specialEconomicZone],'method'=>'POST')) !!}
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="rate_per_acre" class="form-control money_format" placeholder="Rate per Acre" value="{{ old('rate_per_acre') }}" />
                                    @error('rate_per_acre')
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" readonly name="date_of_approval" class="form-control datepicker" placeholder="Date of Approval" value="{{ old('date_of_approval') }}" />
