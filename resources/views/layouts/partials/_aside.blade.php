<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
					...
					<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								 ...
								 <li class="menu-item {{ areActiveRoutes(['home']) }}" aria-haspopup="true">
							 ...
							 <li class="menu-item menu-item-submenu {{ areActiveRoutes([
								...
								<a href="javascript:;" class="menu-link menu-toggle">
									...
									<span class="menu-text">System Definitions</span>
    ...
    'special-economic-zones.industrial-zones.index','special-economic-zones.industrial-zones.create','special-economic-zones.industrial-zones.edit',
											...
											<a href="{{ route('special-economic-zones.index') }}" class="menu-link">
												...
												<span class="menu-text">Special Economic Zones</span>
											</a>
										</li>
                             ...
                             @endhasanyrole
                                ...
                                <li class="menu-item {{ areActiveRoutes(['plots.index','plots.create','plots.edit','plots.split.create', 'plots.merge.create']) }}" aria-haspopup="true">
                                ...
                                <li class="menu-item {{ areActiveRoutes(['plot-allotments.index','plot-allotments.create','plot-allotments.edit']) }}" aria-haspopup="true">
                                    <a href="{{ route('plot-allotments.index') }}" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <span class="menu-text">Plot Allotment</span>
                                    </a>
                                </li>

                                <li class="menu-item {{ areActiveRoutes(['reports.industry-in-production']) }}" aria-haspopup="true">
                                    <a href="{{ route('reports.industry-in-production') }}" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <span class="menu-text">Industry In Production at M-3 Industrial City</span>
                                    </a>
                                </li>
