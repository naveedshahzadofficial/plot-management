...
class StorePlotSplitRequest extends FormRequest
{
    ...
    {
        return [
            'new_plots.*.plot_no'=>['required', 'integer','not_in:0','digits_between:1,10',Rule::unique('plots', 'plot_no')->where('special_economic_zone_id', $this->plot->special_economic_zone_id)],
    ...
    {
        return [
            'new_plots.*.plot_no.unique' => 'This plot is already exist.',
